              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label for="subject">
                                Assunto</label>
                    <input type="text" class="form-control" name="subject" id="subject" placeholder="Assunto" data-rule="minlen:4" data-msg="Digite pelo menos 8 caracteres para o assunto" />
                    <div class="validation"></div>
                  </div>
                </div>
                <div class="col-md-6">
